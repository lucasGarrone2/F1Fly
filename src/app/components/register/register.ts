...
export class Register {
  ...
  protected readonly listaPilotos = [
    'Max Verstappen', 'Lewis Hamilton', 'George Russell', 'Charles Leclerc',
    'Carlos Sainz', 'Lando Norris', 'Oscar Piastri', 'Fernando Alonso',
    'Lance Stroll', 'Esteban Ocon', 'Pierre Gasly', 'Alexander Albon',
    'Franco Colapinto', 'Yuki Tsunoda', 'Nico Hülkenberg', 'Liam Lawson',
    'Isack Hadjar', 'Andrea Kimi Antonelli', 'Gabriel Bortoleto', 'Oliver Bearman'
  ];

  protected readonly listaEscuderias = [
    "Ferrari", "Haas", "Mercedes", "Alpine", "Sauber",
    "Williams", "Aston Martin", "Red Bull", "Racing Bulls", "McLaren"
  ];
  ...
  protected readonly form = this.formBuilder.nonNullable.group({
    ...
    password2: ['', [Validators.required, Validators.minLength(8), Validators.maxLength(16)]],
  ...
  handleSubmit() {
    ...
    try {
      ...
      this.notify.show("Error al registrar usuario", "error");
    }
  }
}